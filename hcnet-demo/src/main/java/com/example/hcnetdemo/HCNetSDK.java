...
public interface HCNetSDK extends StdCallLibrary {
    ...
    //HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(   "libHCNetSDK.dll", HCNetSDK.class);
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(   "E:\\WorkSpace\\hcnet-demo\\lib\\HCNetSDK.dll", HCNetSDK.class);
    /***宏定义***/
    //常量
...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    //设备编码未找到匹配模式配置(NET_DVR_COMPRESSION_AUDIO结构)
    ...
    public static final int COMM_UPLOAD_FACESNAP_RESULT = 0x1112;  //人脸抓拍
...
//校时结构参数
    ...
    public static class NET_DVR_ALARM_ISAPI_INFO extends Structure {//上传报警信息(9000扩展)
